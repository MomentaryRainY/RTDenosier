...
int main() {
    // Box
    filesystem::path inputDir("../box/input");
    filesystem::path outputDir("../box/output");
    int frameNum = 20;

    /*
    // Pink room
    filesystem::path inputDir("pink-room/input");
    filesystem::path outputDir("pink-room/output");
    int frameNum = 80;
    */
